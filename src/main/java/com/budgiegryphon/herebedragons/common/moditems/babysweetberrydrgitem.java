...
public class babysweetberrydrgitem extends Item{
    public babysweetberrydrgitem(Item.Properties properties) {
        super(properties);
    }
    public ActionResultType useOn(ItemUseContext pContext) {
        ...
        if (!world.isClientSide) {
            ...
            if (!(tileentity instanceof CampfireTileEntity)) {
                ...
                entity.absMoveTo(blockpos.getX() + 0.5, blockpos.getY() + 1.0, blockpos.getZ() + 0.5);
